...
namespace Retailer.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20250507041916_AddProduct")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Retailer.Core.Products.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Retailer.Core.DiscountPolicies.Conditions.MinimumTotalDiscountCondition", b =>
                {
            ...
            modelBuilder.Entity("Retailer.Core.DiscountPolicies.Conditions.ProductDiscountCondition", b =>
                {
                    b.HasBaseType("Retailer.Core.DiscountPolicies.DiscountCondition");
            ...
            modelBuilder.Entity("Retailer.Core.DiscountPolicies.Policies.FixedAmountDiscountPolicy", b =>
                {
            ...
            modelBuilder.Entity("Retailer.Core.DiscountPolicies.Policies.PercentageDiscountPolicy", b =>
                {
                    b.HasBaseType("Retailer.Core.DiscountPolicies.DiscountPolicy");
            ...
            modelBuilder.Entity("Retailer.Core.Sales.SaleItem", b =>
                {
                    b.HasOne("Retailer.Core.Products.Product", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Retailer.Core.DiscountPolicies.Conditions.MinimumTotalDiscountCondition", b =>
                {
                    b.HasOne("Retailer.Core.DiscountPolicies.DiscountCondition", null)
                        .WithOne()
                        .HasForeignKey("Retailer.Core.DiscountPolicies.Conditions.MinimumTotalDiscountCondition", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Retailer.Core.DiscountPolicies.Conditions.ProductDiscountCondition", b =>
                {
                    b.HasOne("Retailer.Core.DiscountPolicies.DiscountCondition", null)
                        .WithOne()
                        .HasForeignKey("Retailer.Core.DiscountPolicies.Conditions.ProductDiscountCondition", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
